...
// Заглушки для новых страниц (чтобы приложение не выдавало ошибку)
const DiscountsPage = () => <div className="p-4 text-center text-gray-400 mt-20 font-medium">Раздел скидок появится совсем скоро! 🎁</div>;
const FavoritesPage = () => <div className="p-4 text-center text-gray-400 mt-20 font-medium">Ваше избранное пока пусто ❤️</div>;
...
function Navigation() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#0a0a0a] text-white">
      ...
      {/* Основной контент (увеличен отступ снизу, чтобы меню ничего не перекрывало) */}
      ...
      {/* НОВОЕ КРАСИВОЕ НИЖНЕЕ МЕНЮ (5 КНОПОК) */}
      {!isAdmin && (
        <nav className="fixed bottom-0 left-0 right-0 bg-[#121212]/95 backdrop-blur-lg border-t border-neutral-800 pb-2 pt-2 z-50">
          <div className="flex justify-around items-end px-2">
            ...
            {/* 3. Главная (Парящая центральная кнопка) */}
